    ...
    // This Is My Work
{
    public partial class InventoryPortal : Form
    {
        ...
        private void InventoryDataGrid_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                IDTextBox.Text = Inventory.Rows[InventoryDataGrid.CurrentCell.RowIndex].ItemArray[1].ToString();
                NameTextBox.Text = Inventory.Rows[InventoryDataGrid.CurrentCell.RowIndex].ItemArray[2].ToString();
                QuantityTextBox.Text = Inventory.Rows[InventoryDataGrid.CurrentCell.RowIndex].ItemArray[3].ToString();
                PriceTextBox.Text = Inventory.Rows[InventoryDataGrid.CurrentCell.RowIndex].ItemArray[4].ToString();


            }
            catch (Exception err)
            {
                Console.WriteLine(" Deletion Error: " + err);
            }
        }
